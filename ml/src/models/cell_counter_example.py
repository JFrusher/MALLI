...
Examples:
  ...
  python -m ml.src.models.cell_counter_example --image path/to/image.png

  # Process all PNGs in directory
  python -m ml.src.models.cell_counter_example --directory nih_data --pattern "*.png" --recursive

  # With overlays and CSV export
  python -m ml.src.models.cell_counter_example \\
    --directory nih_data \\
  ...
  python -m ml.src.models.cell_counter_example \\
    ...
    parser.add_argument(
        "--weights",
        type=Path,
        default="experiments/logs/checkpoints/best_mobilenetv3_small.weights.h5",
        help="Path to model weights",
    )
    parser.add_argument(
        "--threshold",
        type=Path,
        default="experiments/logs/checkpoints/decision_threshold.json",
