...
Usage example:
    python -m ml.src.utils.diagnose_full_dataset --zip-path dataverse_files.zip --model-path experiments/logs/checkpoints/best_mobilenetv3_small.weights.h5 --output-dir outputs/diagnostics --write-csv
"""
...
from ..roi_detection.roi_grabber_review import compute_overlay, load_model_from_keras_archive_weights
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model-path", type=Path, default=Path("experiments/logs/checkpoints/best_mobilenetv3_small.weights.h5"))
...
def main() -> None:
    ...
    if args.use_yolo and args.roboflow_api_key:
        try:
            from ..roi_detection.roi_grabber_yolo import download_roboflow_weights
